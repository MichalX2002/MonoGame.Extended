...
{
    /// <summary>
    /// Implementation of a quick random random value generator.
    /// <para/>
    /// Speed comes at the price of 'randomness', there are noticeable
    /// patterns. Compares unfavourably to other algorithms in that respect.
    /// </summary>
    public class FastRandom
    {
        ...
        public FastRandom(int seed)
        {
            if (seed < 1)
                throw new ArgumentOutOfRangeException(
                    nameof(seed), "Seed must be greater than zero.");
        ...
        /// <summary>
        /// Gets the next random integer value which is greater than zero and 
        /// less than or equal to the specified maxmimum value.
        /// </summary>
        ...
        /// <summary>
        /// Gets the next random single value which is greater than zero and 
        /// less than or equal to the specified maxmimum value.
        /// </summary>
