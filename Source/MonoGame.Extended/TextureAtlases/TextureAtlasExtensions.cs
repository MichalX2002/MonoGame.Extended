...
namespace MonoGame.Extended.TextureAtlases
{
    public static class TextureAtlasExtensions
    {
        ...
        public static bool IsVisible(
            this RectangleF sourceRect, ref Vector2 position,
            Vector2 origin, Vector2 scale, RectangleF? clipRect, out RectangleF clippedRect)
        {
        ...
        public static void Draw(
            this SpriteBatch spriteBatch, Texture2D texture, RectangleF sourceRectangle, RectangleF destinationRectangle, Color color, RectangleF? clippingRectangle)
        {
            if (clippingRectangle.HasValue)
            {
