...
namespace MonoGame.Extended.Collections
{
    ...
    public class Deque<T> : IList<T>
    {
        ...
        private T[] _items;
        private Func<int, int> _resizeFunction = DefaultResizeFunction;
        ...
        {
            get => _resizeFunction;
            set => _resizeFunction = value ?? DefaultResizeFunction;
        }
            ...
            set
            {
                if (value < Count)
                    throw new ArgumentOutOfRangeException(nameof(value),
                        "New capacity is not enough to keep current items.");
